...
import { CurrentUserContext } from '../contexts/CurrentUserContext'; // тут должен как-то должен пробрасываться общий контекст

const PopupWithForm = lazy(() => import('host_microfrontend/PopupWithForm').catch(() => {
